      ...
      <div class="card-header">
        <el-row :gutter="20">
          ...
          <el-col :xs="2" :sm="2" :md="2" :lg="2" :xl="2">
            <el-form-item label="" prop="incluirCidade">
              <el-checkbox v-model="filtroParams.ExcluirCidade">Não Incluir</el-checkbox>
            </el-form-item>
          </el-col>
  ...
  export default {
    ...
    methods: {
      ...
      async onSelectUf (val) {
        ...
        delete this.filtroParams.cidadeIBGE
        this.cidadeParams = {
          ...this.cidadeParams,
          ufAbreviado: val,
          cidade_Id: null
