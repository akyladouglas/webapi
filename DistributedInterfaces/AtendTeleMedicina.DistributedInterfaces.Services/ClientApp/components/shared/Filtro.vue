<template>
  ...
  <el-form :model="filtroParams" ref="filtroParams" :rules="filtroValidacoes"
    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="4" :xl="4">
        <el-form-item label="Cartão SUS" prop="cartaoSUS">
          <el-input v-model="filtroParams.cartaoSUS" />
        </el-form-item>
      </el-col>
    ...
    <el-row :gutter="20">
      ...
      <!-- <el-col :xs="24" :sm="24" :md="12" :lg="5" :xl="5">
        <el-form-item label="Data Internação" prop="dataInternacao">
          <el-date-picker prefix-icon="fas fa-calendar-day" v-model="filtroParams.dataInternacao" type="date" format="dd-MM-yyyy" />
        </el-form-item>
      </el-col> -->
      <el-col :xs="24" :sm="24" :md="12" :lg="5" :xl="5">
        <el-form-item label="Dias Internação" prop="diasDeInternacao">
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="6" :xl="6">
        <el-form-item label="Classificação de Risco" prop="corStatusIn">
      ...
      <el-col :xs="24" :sm="24" :md="12" :lg="6" :xl="6">
        <el-form-item label="Acesso Confirmado" prop="confirmado">
          <el-select v-model="filtroParams.confirmado" placeholder="Todos ..." clearable>
            <el-option v-for="item in enums.simNaoTodos" :label="item.label" :value="item.value" :key="item.value" />
          </el-select>
        </el-form-item>
      </el-col>
