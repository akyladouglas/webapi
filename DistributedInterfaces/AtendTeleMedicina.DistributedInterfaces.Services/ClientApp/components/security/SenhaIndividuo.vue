      ...
      <div v-show="opcoes">
        ...
        <form id="formReset" v-show="!listando" class="login-form" v-if="$auth.ready()">
          ...
          <el-form :model="formSenha" status-icon :rules="validacoes" ref="formSenha" label-width="120px" label-position="top" class="form--individuo--senha">
            <el-row :gutter="20">
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <h6 class="text-center">Escolha o Método de Recuperação de Senha</h6><br />
              </el-col>
              <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
    ...
    methods: {
      ...
      async onConfirmar(val) {
        ...
        if (StatusUsuario === 200) {
          ...
          this.$swal({
            title: "Erro!",
            text: 'Verifique se o dado informado para recuperar senha, é de um usuário cadastrado e tente novamente!',
            icon: 'error',
          })
        }
      },
