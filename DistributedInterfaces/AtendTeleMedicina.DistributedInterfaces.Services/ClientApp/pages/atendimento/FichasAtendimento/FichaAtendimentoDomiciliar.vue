...
<script>
  ...
  export default {
    name: 'FichaAtendimentoDomiliciar',
    props: {
      agendamentoProps: {},
      sintomas: {},
      countTimer: '',
    ...
    methods: {
      ...
      onAddButtonProcedimento () {
        ...
        if (findProcedimento.length === 0) {
          return this.$swal({
            title: "Erro!",
            text: 'Ocorreu um erro ao adicionar o procedimento a lista!',
            icon: 'error',
          })
        }
        var objProcedimento = {
        ...
        if (returnProcedimento == false) {
          ...
          this.$swal({
            title: "Atenção!",
            text: 'O procedimento está repetido selecione outro!',
            icon: 'warning',
          })
        }
      ...
      onAddCid10 () {
        if (this.formAtendimento.cid10Adicionados.length > 0) {
          ...
          try {
            ...
            this.$swal({
              title: "Erro!",
              text: 'Ocorreu um erro ao tentar registrar o CID10!',
              icon: 'error',
            })
          }
        }
      ...
      onAddCiap () {
        if (this.formAtendimento.ciap2Adicionados.length > 0) {
          ...
          try {
            ...
            this.$swal({
              title: "Erro!",
              text: 'Ocorreu um erro ao tentar registrar o CIAP!',
              icon: 'error',
            })
          }
        }
      ...
      onAddProcedimento () {
        if (this.formAtendimento.procedimentosAdicionados.length > 0) {
          ...
          try {
            ...
            this.$swal({
              title: "Erro!",
              text: 'Ocorreu um erro ao tentar registrar os procedimentos!',
              icon: 'error',
            })
          }
        }
      ...
      async submitForm(form) {
        ...
        //  return this.$swal({
        //    title: "Atenção!",
        //    text: 'É necessário o preenchimento de pelo menos um CID ou um CIAP!',
        //    icon: 'warning',
        //  })
        //}
        ...
        if (this.formAtendimento.tipoAtendimento != 2 && this.procedimentosAdicionados.length === 0) {
          return this.$swal({
            title: "Atenção!",
        ...
        this.$refs[form].validate(async valid => {
          ...
          if (valid) {
            try {
              ...
              this.$swal({
                title: "Erro!",
                text: 'Ocorreu um erro ao tentar criar o registro do atendimento',
                icon: 'error',
              })
              this.loading.atendimentos = false
            }
