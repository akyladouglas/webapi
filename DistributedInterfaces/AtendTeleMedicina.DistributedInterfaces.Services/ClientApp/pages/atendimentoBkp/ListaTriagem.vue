    ...
    methods: {
      ...
      async onClickSintomas (val) {
        ...
        if (status === 201) {
          ...
          this.$message.warning('Erro No Envio Dos Sintomas')
        }
      },
        ...
        this.$refs[form].validate(valid => {
          ...
          if (valid) {
            if (this.enviouSinaisVitais == true) {
              ...
              if (this.demandaEspontanea == true) {
                ...
                if (putAgendamento.corStatusTriagem <= 2) {
                  ...
                  if (putAgendamento.corStatusTriagem != null) {
                    ...
                    this.$message.warning('Verifique o Grau de Risco')
                  }
                } else {
              ...
              this.$message.warning('O envio dos sinais vitais do paciente é obrigatório!')
            }
          } else {
      ...
      async onClickSalvarSinaisVitais (form) {
        this.$refs[form].validate(async (valid) => {
          ...
          if (valid) {
            ...
            this.$message.warning('Verifique o preenchimento dos sinais vitais')
          }
        })
      },
      ...
      isPdf (file) {
        ...
        if (!isPdf) {
          this.$message.error('O arquivo deve estar no formato PDF, JPEG, JPG, PNG, MP3 ou WAV.')
        }
        return isPdf
      },
      ...
      uploadDocs () {
        ...
        _api.exames.postExames(this.exames).then(res => {
          ...
          if (res.status === 201 || res.status === 200) {
            this.$message.success('Exames Enviados')
            this.loading.exames = false
            this.salvarExames = true
          } else {
            this.$message.warning('Erro Ao Enviar Os Exames')
            this.loading.exames = false
          }
        })
      },
